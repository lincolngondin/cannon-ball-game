...
// Exporta a classe para que outros arquivos (como o world.js) possam importá-la.
export class SimplexNoise {
  ...
  noise2D(x, y) {
    ...
    if (t0 < 0) n0 = 0.0;
      ...
      n0 = t0 * t0 * (this.grad3[g * 3] * x0 + this.grad3[g * 3 + 1] * y0);
    }
    ...
    if (t1 < 0) n1 = 0.0;
      ...
      n1 = t1 * t1 * (this.grad3[g * 3] * x1 + this.grad3[g * 3 + 1] * y1);
    }
    ...
    if (t2 < 0) n2 = 0.0;
      ...
      n2 = t2 * t2 * (this.grad3[g * 3] * x2 + this.grad3[g * 3 + 1] * y2);
    }
